...
class ProxmoxCollector:
    ...
    def __init__(self, host="localhost", port=8006, user=None, password=None,
        ...
        Args:
            ...
            user: Username for password auth (e.g., root@pam)
        ...
        self.proxmox = None
        self._connect(user, password, token_id, token_secret)

    def _connect(self, user, password, token_id, token_secret):
        ...
        try:
            if token_id and token_secret:
                ...
                log(f"Connected to Proxmox at {self.host}:{self.port} using password auth", 'debug')
            else:
...
def proxmox_metrics(host="localhost", port=8006, user=None, password=None,
                    token_id=None, token_secret=None, verify_ssl=True):
    """
